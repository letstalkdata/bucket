...
echo "ALTER USER 'root'@'localhost' IDENTIFIED BY 'Bucket1!sql'; flush privileges;" > reset_pass.sql
...
#
echo "create user 'root'@'%' identified by 'Bucket1!sql';" > remoteAccess.sql
...
#
#
echo "create user 'demo'@'%' identified by 'Bucket1!sql';" > remoteAccess.sql
